...
Then indicate which gamble you like to participate in by pressing the button below the gamble.</p>
...
<TD ID="btn_1" style="border-left-style: none; border-right-style: none; border-bottom-style: none;"> </TD><TD ID="btn_2" style="border-left-style: none; border-right-style: none; border-bottom-style: none;"> </TD><TD ID="btn_3" style="border-left-style: none; border-right-style: none; border-bottom-style: none;" align=center valign=middle><INPUT type="button" name="btn4" value="Option B" onMouseOver="timefunction('mouseover','btn4','Option B')" onClick="recChoice('onclick','btn4','Option B')" onMouseOut="timefunction('mouseout','btn4','Option B')"></TD>
<TD ID="btn_4" style="border-left-style: none; border-right-style: none; border-bottom-style: none;"> </TD></TR></TABLE>
<!-- END MOUSELAB TABLE -->
<!--BEGIN postHTML-->
